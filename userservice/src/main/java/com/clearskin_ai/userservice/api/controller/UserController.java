...
public class UserController {
    ...
    public ResponseEntity<String> adminRegisterUser(@RequestBody AdminRegisterUserDto user) {
    ...
    public ResponseEntity<LoginUserDto> loginUser(@RequestBody LoginUserDto user) {
        LoginUserDto loggedUser = userService.loginUser(user);
